...
public extension MTLTexture {
    ...
    func sameSizeEmptyTexture()-> MTLTexture? {
...
public extension MTLDevice {
    ...
    func newComputePipelineStateWithName(functionName:String) -> MTLComputePipelineState? {
...
public extension MTLCommandQueue{
    ...
    func addCommand<T>(pipelineState:MTLComputePipelineState,textures:[MTLTexture],factors:[T]) {
